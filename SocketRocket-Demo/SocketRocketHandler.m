...
#define ServerURL   @"ws://echo.websocket.org"
...
@interface SocketRocketHandler () <SRWebSocketDelegate>
{
...
@implementation SocketRocketHandler

+ (instancetype)sharedSocketRocketHandler
{
    static dispatch_once_t onceToken;
    static SocketRocketHandler *instance = nil;
